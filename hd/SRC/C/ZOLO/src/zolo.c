...
int main() {
  ...
  while (cx > 300) {
    ...
    plan_vwalls(&maze, &maze_render_conf, cx, cy, *logical_page, &sprites, false, log_file);
    plan_hwalls(&maze, &maze_render_conf, cx, cy, *logical_page, &sprites, false, log_file);
