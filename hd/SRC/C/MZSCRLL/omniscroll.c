...
void render_maze(byte mode, word** maze, word cx, word cy, void* screenbase, void* spritebase) {
  Vsync();
...
int main() {
  ...
  while (keep_looping) {
    render_maze(ERASE_MODE, maze, old_vx, old_vy, logbase, sprite_screen.base);
