	...
	lea Source, A0       ; Load address of source into A0
	lea Destination, A1  ; Load address of destination into A1
...
copy_loop:
	...
	; Print the runtime
	LEA runtime_msg, A0  ; Load the address of the runtime message
...
print_number:
	...
	LEA num_buffer, A1   ; Buffer to store the number as ASCII
...
print_number_loop:
	...
	SWAP D1              ; Bring quotient to lower word
